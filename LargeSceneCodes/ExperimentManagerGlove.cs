...
public class ExperimentManagerGlove : MonoBehaviour
{
    ...
    {	
		...
		for(int ip = 0; ip < numberOfPracticeTrials; ip++)		// practice session
		{
			...
			if((responses[trialCounter, 5]!=0 & raisedGloveColor==0 & DominantColor==2) | (responses[trialCounter, 5]!=0 & raisedGloveColor==1 & DominantColor==1))
			{
